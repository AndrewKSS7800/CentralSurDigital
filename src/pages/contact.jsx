...
const Contact = () => {
    ...
    return (
        <section className="contact">
            ...
            <div className="ccon">
                <a href="https://maps.app.goo.gl/mZ4etsWpP3V2eytB9" target="_blank" className="ccont">
                    ...
                    <span>Villa María del Triunfo</span>
                </a>
                ...
                <a href="mailto:centralsurdigitalnoticias@gmail.com" target="_blank" className="ccont">
                    ...
                    <span>CentralSurDigitalNoticias@gmail.com</span>
                </a>
            </div>
            <div className="cform">
                <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3900.5358621521405!2d-76.9518099413721!3d-12.143876846754269!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9105b8917cb616cb%3A0x354de2992530dcfa!2sMonzon%20289%2C%20Villa%20Mar%C3%ADa%20del%20Triunfo%2015812!5e0!3m2!1ses!2spe!4v1746550975953!5m2!1ses!2spe"
                width="600"
                height="450"
                style={{ border: 0 }}
                allowFullScreen
